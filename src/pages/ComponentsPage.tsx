        ...
        {import.meta.env.DEV && (
          <Card className="p-8 bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800">
            <div className="text-center mb-6">
              ...
              <p className="text-base text-green-600 dark:text-green-400">{developmentStatus.description}</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                <h3 className="font-medium text-green-700 dark:text-green-300 mb-2">{developmentStatus.modulesHeading}</h3>
                <ul className="space-y-1 text-green-600 dark:text-green-400">
                  {developmentStatus.modules.map((module) => (
                    <li key={module}>{module}</li>
                  ))}
                </ul>
              </div>
              <div>
                <h3 className="font-medium text-green-700 dark:text-green-300 mb-2">{developmentStatus.featuresHeading}</h3>
                <ul className="space-y-1 text-green-600 dark:text-green-400">
                  {developmentStatus.features.map((feature) => (
